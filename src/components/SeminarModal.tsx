            ...
            <div className="p-6 overflow-y-auto flex-1">
              {activeTab === 'details' ? (
                <div className="space-y-4">
                  ...
                  <button
                    onClick={() => setActiveTab('register')}
                    className="w-full bg-brand hover:bg-brand-hover text-brand-contrast hover:text-white font-semibold py-2.5 px-4 rounded-xl shadow transition-all duration-300 flex items-center justify-center gap-2 text-sm cursor-pointer mt-4"
                  >
                ...
                <form onSubmit={handleRegister} className="space-y-4">
                  ...
                  <button
                    type="submit"
                    className="w-full bg-brand hover:bg-brand-hover text-brand-contrast hover:text-white font-bold py-2.5 px-4 rounded-xl shadow transition-all duration-300 flex items-center justify-center gap-2 text-sm cursor-pointer"
                  >
